  ...
  public static synchronized void update(String data)
  {
    ...
    case 0:
        if (parts[5].charAt(0) == 'T') {
          AutomaticControl.heating();
        }
        else if (parts[5].charAt(0) == 'L') {
          AutomaticControl.lights();
        }
        else if (parts[5].charAt(0) == 'F') {
          AutomaticControl.fan();
        }
        else
    ...
    case 1:
        if (parts[5].charAt(0) == 'T') {
          ManualControl.heating(parts[5].substring(1, 2));
        }
        else if (parts[5].charAt(0) == 'L') {
          //ManualControl.lights(parts[5], parts[6]);
        }
        else if (parts[5].charAt(0) == 'F') {
          //ManualControl.fan(parts[5], parts[6]);
        }
        else
          System.out.println("no valid Data");
    }
